...
const Login = () => {
    ...
    const {setStudentState} = UseStudent();
    ...
    const login = async (e) => {
      e.preventDefault();
        ...
        await axios.post("http://localhost:4000/api/students/login", data).then((response) => {
    ...
    <div className='min-h-screen flex flex-col md:flex-row'>
         <div className='relative w-full md:w-1/2 h-64 md:h-auto'>
            ...
            <div className='relative flex flex-col justify-center z-10 h-full p-8 text-white'>
              ...
              <h1 className='text-2xl md:text-3xl font-medium mb-4'>Login to continue</h1>
         ...
         <div className='w-full md:w-1/2 flex items-center justify-center p-6 md:p-12 bg-gray-50'>
            <div className='w-full max-w-md'>
              <div className='text-center mb-8'>
                <h1 className='text-2xl md:text-3xl font-bold text-gray-800 mb-2'>Sign in to your account</h1>
              </div>
              <form className='space-y-6'>
                <div>
                <label htmlFor='username' className='block text-sm font-medium text-gray-700 mb-1'>ID:</label>       
                  <input type="number" 
